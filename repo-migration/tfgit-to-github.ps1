...
foreach ($project in $jsonContent) {
    ...
    foreach ($repo in $repositories) {
        ...
        if ($repoType -eq "GIT") {
            ...
            # Construct the secure clone URL
            ...
            #     # Update the remote URL instead of removing it
            #     git remote set-url origin "https://x-access-token:$GitHubToken@github.com/$GitHubOrg/$repoName.git" -ErrorAction SilentlyContinue
